...
function extractCity(text, language = "en") {
    return text.trim(); // Simply return the user's input as the city name
}
        ...
        switch (session.step) {
            ...
            case STATES.LONGITUDE:
                ...
                case STATES.CITY_SELECTION:
                    ...
                    session.step = STATES.STREET; // Ensure transition to city selection
                    userSessions[from] = session;
                    
                    await sendToWhatsApp(from, "🌍 Please select your street.");
